...
async def create_task(request: TaskRequest) -> TaskResponse:
    ...
    try:
        ...
        return TaskResponse(task_id=uuid.UUID(workflow_record.workflow_id), status="completed")
    except Exception as e:
        print(f"Graph execution failed: {e}")
        return TaskResponse(task_id=uuid.UUID(workflow_record.workflow_id), status="failed")
